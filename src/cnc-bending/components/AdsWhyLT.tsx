...
import { CheckCircle2, Award, Users, Wrench, GraduationCap } from "lucide-react";
      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
        ...
        <div className="lg:w-1/2">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-10 leading-relaxed font-primary">
              Upgrade the Way You Bend, Build and Scale
            </p>
          </motion.div>
          ...
          >
            <div className="bg-gray-100 aspect-[4/3] flex items-center justify-center overflow-hidden">
              <img
                ...
                alt="CNC Bending Machine by Laser Technologies"
                className="w-full h-full object-cover mix-blend-multiply"
              />
            </div>
            <div className="p-6">
              <h3 className="text-2xl font-medium text-gray-900 mb-4 font-primary">
                India's Most Trusted CNC Bending Machine Manufacturer
              </h3>
              <p className="text-gray-600 text-base leading-relaxed">
                With 15+ years of manufacturing experience, 5,500+ machines deployed, and a pan-India service network, Laser Technologies is India's most trusted CNC bending machine manufacturer. Every press brake, panel bender, and pipe bending system we supply is backed by application support, operator training through Laser Gurukul, and the deep after-sales infrastructure that keeps your production running long after installation. From your first enquiry to years of reliable bending output, we are with you at every stage.
