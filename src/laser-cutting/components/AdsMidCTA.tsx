    ...
    <section className="relative py-24 md:py-28 text-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
        >
          Not Sure Which Machine Fits Your{" "}
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Our application team works with manufacturers across India to identify the right CNC
          laser cutting machine for their specific material, thickness, and production volume. Tell
          us what you need and we will come back with a recommendation.
        </motion.p>
