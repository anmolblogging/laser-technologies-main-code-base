...
const testimonialsData: Testimonial[] = [
  ...
  },
  {
    ...
    header: "Laser Fab Engineers' Journey to Excellence with HSG Fiber Laser Machines",
    description:
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-gray-600">
            Real stories from businesses transformed by our precision laser systems.
          </p>
        </div>
        ...
        <div className="relative overflow-hidden">
          ...
          <button
            onClick={prevSlide}
            className="absolute top-1/2 left-4 -translate-y-1/2 w-12 h-12 rounded-full bg-transparent text-black hover:text-white flex items-center justify-center shadow-lg hover:bg-red-700 transition-transform duration-300 hover:-translate-x-1"
          >
            <ChevronLeft className="w-5 h-5" />
          </button>
          <button
            onClick={nextSlide}
            className="absolute top-1/2 right-4 -translate-y-1/2 w-12 h-12 rounded-full bg-transparent text-black hover:text-white flex items-center justify-center shadow-lg hover:bg-red-700 transition-transform duration-300 hover:translate-x-1"
          >
