...
const HeroBanner = () => {
  return (
    <section className="relative bg-gray-50 mt-[75px] mb-[200px] md:mb-200 lg:mb-0">
        ...
        <div className="relative z-10 container mx-auto px-6 sm:px-8 lg:px-12 py-10 lg:py-24">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-10 md:space-y-8">
            <div className="space-y-6 md:space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-light text-white leading-tight md:leading-snug">
                Sharper. Faster.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 md:pt-2">
              <button type="button" className="bg-red-600 text-white px-10 py-4 text-base font-medium hover:bg-red-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-black" > Explore Products </button>
            </div>
          </div>
        </div>
        ...
        <div className="my-[-20px] lg:my-0 block absolute bottom-0 left-0 right-0 z-20 transform translate-y-1/2 px-6 lg:px-12 md:translate-y-[35%]">
          <div className="container mx-auto">
            <div className="max-w-5xl mx-auto">
              <div className="aspect-video bg-black overflow-hidden shadow-2xl md:rounded-xl md:border md:border-red-600/40">
                <iframe
      ...
      <div className="relative bg-gray-50 pt-0 lg:pt-64 xl:pt-80 "></div>
    </section>
  );
};
