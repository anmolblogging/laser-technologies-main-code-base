...
const Posts = () => {
  ...
  // 🔒 STATIC CATEGORY: always CSR
  const currentCategory = "CSR";
  ...
  const fetchPosts = async () => {
    try {
      ...
      // 🔒 Always filter by CSR (since currentCategory is "CSR")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-red-50">
      ...
      {/* Hero Section */}
      <section className="relative pt-12 md:pt-20 mt-16 md:mt-20 text-black bg-white  pb-12 sm:pb-14 md:pb-16" style={{ backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto py-10 text-center">
            <h1 className="text-4xl  md:text-5xl lg:text-7xl font-medium  mb-4 sm:mb-6 font-primary px-4">
              {currentCategory === "All" ? "Explore All Content" : currentCategory}
            </h1>
            <p className="text-base pb-4 sm:text-lg md:text-xl max-w-2xl mx-auto font-secondary px-4 ">
