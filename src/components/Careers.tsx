...
export default function Careers() {
  ...
  return (
    <div className="min-h-screen bg-white font-secondary">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="flex gap-4">
                    <div className="flex-shrink-0 w-1.5 rounded-full mt-2 bg-whiteBgButtonBg" style={{ height: '40px' }}></div>
                    <div>
            ...
            <div className="relative">
                    ...
                    <img src="https://www.lasertechnologies.co.in/images/career/slider-1.webp" alt=""
                    className='h-216 w-116' />
          ...
          <div className="bg-white p-12 md:p-16 shadow-sm">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-shrink-0">
                <div className="w-24 h-24 flex items-center justify-center bg-whiteBgButtonBg">
                  <svg className="w-12 h-12 text-darkBgText" fill="currentColor" viewBox="0 0 20 20">
      ...
      {/* CTA Section */}
      <section className="py-24 md:py-32 bg-gradient-to-br from-red-950 via-red-900 to-red-950 text-white relative overflow-hidden font-primary">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-red-100 mb-12 leading-relaxed font-light">
            We're always looking for exceptional talent. Share your resume and let's explore how you can contribute to our mission.
          </p>
          <button className="inline-flex items-center gap-3 px-10 py-5 bg-white  text-lg transition-all duration-300 hover:shadow-2xl hover:scale-105 font-primary text-whiteBgButtonBg">
            Get in Touch
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
            </svg>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600 font-light">
                <p className="flex items-start gap-3 text-lg">
                  <svg className="w-6 h-6 mt-1 flex-shrink-0 text-whiteBgButtonBg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
