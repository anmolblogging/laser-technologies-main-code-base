...
`,
        ProductVideoURL:
          "https://www.youtube.com/embed/ruvxBuI_DeY?si=As2QGO9XKjprNHbc",
        CuttingSamplesURL:
  ...
  {"Model": "G12025X", "Power": "12000W-30000W", "Processing format (L*W)": "12500mm*2540mm", "X/Y-axis Positioning Accuracy": "±0.03mm/m"}
        ...
        ProductVideoURL:
          "https://www.youtube.com/embed/5pAGM1vNdFA?si=DmInfo_BAdk3jWzb",
        CuttingSamplesURL:
...
`,
        ProductVideoURL:
          "https://www.youtube.com/embed/enoVPA0T2P4?si=8euD1JbyMVXtN2PR",
        CuttingSamplesURL:
...
`,
    ...
    "Tube Cutting Machine or Pipe Cutting Machine": [
      {
        Segment: "Cutting",
        SubCategory: "Tube Cutting Machine or Pipe Cutting Machine",
        ProductName: "R1",
      },
      {
        Segment: "Cutting",
    ...
    "Sheet and Tube Cutting Machine": [
      {
        Segment: "Cutting",
        SubCategory: "Sheet and Tube Cutting Machine",
        ProductName: "GB",
      },
    ],
    "Fully Automatic Sheet Cutting Machine": [
      {
        Segment: "Cutting",
        SubCategory: "Fully Automatic Sheet Cutting Machine",
        ProductName: "ALG (Loading And Unloading) ",
      },
    ],
    "Electrical Steel / Electrolamination Sheet Cutting Machine": [
      {
        ...
        SubCategory:
          "Electrical Steel / Electrolamination Sheet Cutting Machine",
        ProductName: "Effective S",
      },
      {
        Segment: "Cutting",
        SubCategory:
          "Electrical Steel / Electrolamination Sheet Cutting Machine",
        ProductName: "Effective L",
      },
    ],
  },
  SheetBending: {
    "NC Sheet Bending Machine (straightforward, repetitive, or simple-angle jobs.)":
      [
        {
          Segment: "Sheet Bending",
          SubCategory:
            "NC Sheet Bending Machine (straightforward, repetitive, or simple-angle jobs.)",
          ProductName: "Upstroke NC Press Brake",
        },
      ],
      ...
      [
        {
          ...
          SubCategory:
            "CNC Sheet Bending Machine (Complex Jobs- multi-angle, precise, and variable geometry jobs, including high-volume or highly customized applications.)",
          ProductName: "Downstroke CNC Press Brake",
        },
      ],
      ...
      [
        {
          ...
          SubCategory:
            "Pump-Controlled CNC Sheet Bending Machine (Mass Production and Energy Efficient) Designed for heavy-gauge, thick sheets, high tonnage, intricate curves, and large-scale or specialized components requiring strong hydraulic force.",
          ProductName: "Pump Control CNC Press Brake",
        },
      ],
      ...
      [
        {
          ...
          SubCategory:
            '"CNC V-Grooving Machine (CNC V-Grooving Machines are ideal for pre-scoring panels for bending, producing high-precision fold lines, and supporting complex, multi-angle, or aesthetic designs.\n\nWidely used in industries requiring repeatable folds, decorative panels, or functional sheet bending without deforming the material.)"',
          ProductName: "Double-Head Vertical CNC V-Grooving Machine",
        },
      ],
    PowerBend: [
      {
        Segment: "Sheet Bending",
        SubCategory: "Power Bend",
        ProductName: "Power Bend",
      },
    ],
    SmartBend: [
      {
        Segment: "Sheet Bending",
        SubCategory: "Smart Bend",
        ProductName: "Effective Bend",
      },
    ],
    PanelBender: [
      {
        Segment: "Sheet Bending",
        SubCategory: "Panel Bender",
        ProductName: "PBE Series",
      },
    ],
  },
  PipeAndTubeBending: {
    "Pipe and Tube Bending Machine ": [
      {
        Segment: "Pipe and Tube Bending",
        SubCategory: "Pipe and Tube Bending Machine ",
        ProductName: "BLMA",
      },
    ],
  },
  SheetPunching: {
    "CNC Turret Punch Press": [
      {
        Segment: "Sheet Punching",
        SubCategory: "CNC Turret Punch Press",
        ProductName: "Dardontech\n",
      },
    ],
  },
  Welding: {
    "Handheld Laser Welding Machine": [
      {
        Segment: "Welding",
        SubCategory: "Handheld Laser Welding Machine",
        ProductName: "Smart Weld",
      },
    ],
    "Air-Cooled Handheld Laser Welding Machine": [
      {
        Segment: "Welding",
        SubCategory: "Air-Cooled Handheld Laser Welding Machine",
        ProductName: "Air-Cooled",
      },
    ],
    "Robotic Laser Welding Machine": [
      {
        Segment: "Welding",
        SubCategory: "Robotic Laser Welding Machine",
        ProductName: "CoboWeld",
      },
    ],
    "Open Laser Welding Machine": [
      {
        Segment: "Welding",
        SubCategory: "Open Laser Welding Machine",
        ProductName: "AL Series",
      },
      {
        Segment: "Welding",
        SubCategory: "Open Laser Welding Machine",
      ...
      },
      {
        Segment: "Welding",
        SubCategory: "Open Laser Welding Machine",
        ProductName: "AL-F OEM",
      },
      {
        Segment: "Welding",
        SubCategory: "Open Laser Welding Machine",
        ProductName: "AL-ROCK Modular",
      },
      {
        Segment: "Welding",
        SubCategory: "Open Laser Welding Machine",
    ...
    "Closed Laser Welding Machine": [
      {
        Segment: "Welding",
        SubCategory: "Closed Laser Welding Machine",
        ProductName: "ALW",
      },
      {
        Segment: "Welding",
    ...
    "Pillow Plate Laser Welding Machine": [
      {
        Segment: "Welding",
        SubCategory: "Pillow Plate Laser Welding Machine",
        ProductName: "Pillow Plate Laser Welding Machine",
      },
    ],
  },
  Marking: {
    "Fiber Laser Marking Machine": [
      {
        Segment: "Marking",
        SubCategory: "Fiber Laser Marking Machine",
        ProductName: "iMark Series",
      },
    ],
    "CO₂ Laser Marking Machine": [
      {
        Segment: "Marking",
        SubCategory: "CO₂ Laser Marking Machine",
        ProductName: "iMark CO2",
      },
    ],
    "UV Laser Marking Machine": [
      {
        Segment: "Marking",
        SubCategory: "UV Laser Marking Machine",
        ProductName: "iMark UV",
      },
    ],
  },
  Engraving: {
    "CO₂ Laser Engraving Machine": [
      {
        Segment: "Engraving",
        SubCategory: "CO₂ Laser Engraving Machine",
        ProductName: "Spirit GLS Engraver",
      },
      {
        Segment: "Engraving",
        SubCategory: "CO₂ Laser Engraving Machine",
        ProductName: "Spirit GLS Hybrid",
      },
    ],
  },
};
