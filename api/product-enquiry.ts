    ...
    await supabase.from("leads").insert([
      {
        ...
        message: `Segment: ${product_segment || 'N/A'} | Subcategory: ${product_subcategory || 'N/A'}`,
...
<head>
  ...
  <title>Product Enquiry — ${product_name}</title>
</head>
...
<table width="620" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td style="padding:16px 20px;border-right:1px solid #fde8e8;vertical-align:top;" width="50%">
            <p style="margin:0 0 4px;font-size:9px;font-weight:700;color:#e8111f;
                       letter-spacing:1.5px;text-transform:uppercase;">Product</p>
          ...
          <td style="padding:16px 20px;vertical-align:top;" width="50%">
            ...
            <p style="margin:0;font-size:13px;color:#1a1a1a;font-weight:500;line-height:1.4;">${product_segment}</p>
          </td>
        </tr>
        ${product_subcategory ? `
        <tr>
          <td colspan="2" style="padding:12px 20px;border-top:1px solid #fde8e8;vertical-align:top;">
            <p style="margin:0 0 4px;font-size:9px;font-weight:700;color:#bbb;
                       letter-spacing:1.5px;text-transform:uppercase;">Subcategory</p>
            <p style="margin:0;font-size:13px;color:#1a1a1a;font-weight:500;line-height:1.4;">${product_subcategory}</p>
          </td>
        </tr>` : ""}
      </table>
    </td>
  ...
  <tr>
    <td style="padding:26px 40px 34px;">
      <a href="mailto:${email}?subject=Re%3A%20Your%20Product%20Enquiry%20%E2%80%94%20${encodeURIComponent(product_name)}&body=Hi%20${encodeURIComponent(firstName)}%2C%0A%0AThank%20you%20for%20your%20enquiry%20about%20${encodeURIComponent(product_name)}.%20"
...
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width,initial-scale=1.0"/>
  <title>Enquiry Received — Laser Technologies</title>
</head>
<body style="margin:0;padding:0;background:#f5f5f7;font-family:Helvetica,Arial,sans-serif;">
<table width="100%" cellpadding="0" cellspacing="0" border="0"
  style="background:#f5f5f7;padding:52px 20px;">
  ...
  <tr>
    <td style="padding:38px 40px 30px;">
      ...
      <p style="margin:0 0 14px;font-size:15px;color:#444;line-height:1.85;font-weight:400;">
        ...
        <strong style="color:#0f0f0f;font-weight:600;">${product_name}</strong>.
        Our team will get back to you within <strong style="color:#0f0f0f;font-weight:600;">24 hours</strong>.
      </p>
      <p style="margin:0;font-size:14px;color:#aaa;line-height:1.8;font-weight:400;">
        Need to reach us sooner? Call us on
...
<p style="margin:20px 0 0;font-size:10.5px;color:#ccc;text-align:center;font-weight:400;">
  Laser Technologies Private Limited
    ...
    await transporter.sendMail({
      ...
      replyTo: email,
      subject: `MAIN-WEBSITE [Product Enquiry] ${product_name} — ${name}`,
      html: adminHtml,
    });
    ...
    await transporter.sendMail({
      from: `"Laser Technologies" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: `We received your enquiry — Laser Technologies`,
      html: autoReplyHtml,
    });
